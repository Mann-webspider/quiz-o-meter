...
import Avatar, { genConfig } from "react-nice-avatar"; // Fixed import
...
function WaitingRoom() {
  ...
  useEffect(() => {
    ...
    console.log("Joining waiting room:", cookies.roomId);
        ...
        {participants.length === 0 ? (
          ...
          <div className="relative w-full h-full">
            {participants.map((participant, index) => {
              ...
              // Fixed: use genConfig instead of generateConfig
